...
def main():
    ...
    parser.add_argument('--save_folder', dest = 'save_folder', type = str, default = './testset/val/', help = 'the folder to save the graph data')
    args = parser.parse_args()
    
    test_list = ['cvs08r139-94','cvs16r70-62','cvs16r89-60']
    setup_seed(args.seed)
    dataset = CVSDownstreamVal(args.primal, args.primal_solution, test_list, args.save_folder)
