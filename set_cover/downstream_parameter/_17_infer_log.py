...
def main():
    ...
    parser.add_argument('--primal_folder', dest = 'primal_folder', type = str, default = '../data/primal_format/m200n400_mixed2/', help = 'which folder to get the lp instances')
    parser.add_argument('--generate_primal_folder', dest = 'generate_primal_folder', type = str, default = '../data/generate_primal/m200n400_mixed2/', help = 'which folder to get the lp instances')
    ...
    parser.add_argument('--save_folder', dest = 'save_folder', type = str, default = './time_log0/', help = 'which folder to get the lp instances')
    ...
    for instance_idx in tqdm(range(args.num_instance)):
        ...
        solver.setRealParam('limits/gap', 0)
        solver.setRealParam('limits/time', 20)
        ...
        for ratio in args.ratio_list:
            problem_instance = args.generate_primal_folder+"{:.2f}".format(ratio).replace('.','')+'_a5wobnumx_regression_nosigmoid/'+str(instance_idx)+'.lp'
