...
def main():
    ...
    parser.add_argument('--save_folder', dest = 'save_folder', type = str, default = '../downstream_parameter', help = 'which folder to get the lp instances')
    ...
    for trial_id in range(0,3):
        ...
        for seed in range(45):
            ...
            generate_path_1 = save_folder + 'generate1.npy'
            generate_path_2 = save_folder + 'generate2.npy'
            generate_path_3 = save_folder + 'generate3.npy'
