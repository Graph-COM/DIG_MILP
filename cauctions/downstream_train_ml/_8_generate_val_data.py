...
class CauctionsDownstreamVal(InMemoryDataset):
    def __init__(self, primal, num_instance, save_folder):
        self.save_folder = Path(save_folder)
        self.num_instance = num_instance
        self.primal = primal
        super(CauctionsDownstreamVal, self).__init__(root = self.save_folder)
...
def main():
    ...
    parser.add_argument('--primal', dest = 'primal', type = str, default = './testset/', help = 'which folder to get the primal instances')
    ...
    dataset = CauctionsDownstreamVal(primal, args.num_instance, save_folder)
