...
def main():
    ...
    parser.add_argument('--train_folder', type = str, dest = 'train_folder', default = './train_files/001/', help = 'folder to save the trained models')
    ...
    parser.add_argument('--generate_primal', dest = 'generate_primal', type = str, default = '../data/generate_primal/001_a150lr1e3/', help = 'which folder to get the generated primal instances')
    ...
    parser.add_argument('--generate_primal_solution', dest = 'generate_primal_solution', type = str, default = './dataset/generate_primal_solution/001_a150lr1e3/', help = 'the folder to get the primal solution')
    parser.add_argument('--normalize_statistics', dest = 'normalize_statistics', type = str, default = './dataset/001_a150lr1e3/', help = 'the folder to get the normalize data')
